...
from ... import config
from ...core.data_structures import SERoute, FERoute, Solution
from ...core.problem_parser import Customer

if TYPE_CHECKING:
    from ...core.problem_parser import ProblemInstance, Satellite
    from ...core.transaction import RouteMemento
