...
# Hằng số để chuẩn hóa thước đo thời gian, dựa trên thời gian hoạt động trong ngày 
# (ví dụ: 15 giờ * 60 phút = 900 phút)
MAX_SCHEDULING_FLEXIBILITY = 900.0

# Lưu ý: Các tham số về xe (SE_VEHICLE_SPEED, FE_VEHICLE_SPEED, ...) đã có trong
# config của ALNS nên không cần thêm lại. Chúng ta sẽ sử dụng chung.

# ==============================================================================
# 9. CẤU HÌNH ĐƯỜNG DẪN VÀ THƯ MỤC (PATHS & DIRECTORIES)
# ==============================================================================
# Đổi tên và hợp nhất các đường dẫn
# Đường dẫn đầy đủ đến file dữ liệu đầu vào
# (Bạn có thể bỏ DATA_PATH cũ từ config của clustering)
# Thư mục gốc để lưu tất cả kết quả chạy
